    ...
    <div>
        ...
        <li className=" ml-[2em] py-[17px]">
          ...
          <li className="mt-[1.9em] ml-[25rem]">
             <Link to="/"  className={" hover:text-[#12B0DF] hover:underline-offset-4 hover:underline font-[797] font-inter font-[700] text-xl cursor-pointer "
             +(path == "/" ? " text-[#12B0DF] underline-offset-4 underline" : "")  } 
             onClick={() => setPath('/')}
              >Trang Chủ </Link> 
          </li>
          ...
          <li className="mt-[1.9em] ml-[4rem]">
            <Link to="/about" className={"hover:text-[#12B0DF] hover:underline-offset-4 hover:underline font-[797] font-[700] text-xl cursor-pointer "
             +(path == "/about" ? " text-[#12B0DF] underline-offset-4 underline" : "")  }  onClick={() => setPath('/about')}>About </Link> 
          </li>

          <li className="mt-[1.9em] ml-[4rem] ">
            <Link to="/thiThu" className={"hover:text-[#12B0DF] hover:underline-offset-4 hover:underline font-[797] font-[700] text-xl cursor-pointer"
             +(path == "/thiThu" ? " text-[#12B0DF] underline-offset-4 underline" : "")  }  onClick={() => setPath('/thiThu')}>Thi Thử </Link> 
          </li>
          <li className="mt-[1.9em] ml-[4rem]">
            <Link to="/taiLieu" className={"hover:text-[#12B0DF] hover:underline-offset-4 hover:underline font-[797] font-[700] text-xl cursor-pointer "
          ...
          <li className="flex ">
              <a className="cursor-pointer mt-[2.1em] ml-[2em]"   href="https://www.linkedin.com/" target="_blank" >
                  <IconLinkedin/>
              </a>
              <a className="cursor-pointer mt-[2.1em]  ml-[2em]" href="https://github.com/FunDev-Team" target="_blank">
              <IconGithub/>
              </a>
          </li>
